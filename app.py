...
st.markdown("""
    ...
    /* Contenitore logo spostato a destra */
    .logo-container {
        margin-left: 6cm;  /* sposta logo 6cm a destra */
        margin-bottom: 10px;
        filter: drop-shadow(0 0 4px rgba(255, 255, 255, 0.8)); /* ombra chiara */
    }

    /* Titoli */
    h1, h2 {
        color: #222222 !important; /* forza colore scuro */
        text-align: center;
        margin: 0;
        font-weight: 700;
        text-shadow: 1px 1px 2px rgba(255,255,255,0.6); /* ombra leggera bianca per contrasto */
    }
    h1 {
        font-size: 2.6rem;
        margin-bottom: 5px;
    ...
    <div class="logo-container">
        <img src="Palazzo_Adriano-Stemma.png" width="120" />
    </div>
