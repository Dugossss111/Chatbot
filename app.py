...
# Titolo unico con a capo
st.markdown("""
<h1 style="position: relative; z-index: 10000; line-height: 1.2; text-align: center; font-weight: 700; text-shadow: 1px 1px 2px rgba(255,255,255,0.6); color: #222222; margin: 0;">
Assistente Virtuale<br>
<span style="font-size: 1.5rem; font-weight: 400;">del Comune di Palazzo Adriano</span>
</h1>
""", unsafe_allow_html=True)

# Caricamento PDF e QA
