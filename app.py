...
st.markdown("""
<style>
/* Nascondi il footer di default */
footer {
    visibility: hidden;
}

/* Footer personalizzato fisso in basso */
footer:after {
    content: "Questo assistente utilizza l’AI e potrebbe commettere errori. Verifica sempre le informazioni importanti. | © 2025 – Sviluppato da Emily D'Ugo";
    visibility: visible;
    display: block;
    position: fixed;
    bottom: 0;
