...
.custom-title {
    ...
    line-height: 1.2;
    font-weight: 700;
    margin-top: 5rem;  /* Spazio per stare sotto la barra fissa */
...
.custom-title span {
    ...
    font-size: 2.0rem; /* leggermente più piccolo */
}
...
# Layout colonne e logo centrato sotto il titolo
