...
/* Stile per campo input */
input[type="text"] {
    background-color: #f9f9f9 !important;  /* stesso colore dello sfondo pagina */
    color: #222222 !important;             /* testo scuro e leggibile */
    border: 1.5px solid #d71921 !important; /* bordo rosso per far risaltare il campo */
    border-radius: 6px !important;          /* angoli arrotondati */
    padding: 10px !important;               /* spazio interno */
    font-size: 16px !important;
    outline: none !important;               /* togli outline di default */
    box-shadow: 0 0 5px #d71921aa !important; /* leggero alone rosso */
    caret-color: #d71921 !important;        /* cursore rosso */
}
...
input::placeholder {
    color: #222222 !important;
    opacity: 1 !important;
    font-weight: 600 !important; /* più evidente */
    text-shadow: 0 0 2px white !important; /* leggera ombra per risalto */
}
</style>
