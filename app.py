...
st.markdown(
    ...
    <style>
        ...
        /* Per evitare che la barra copra il contenuto */
        .block-container {
            padding-top: 48px;
        }
    </style>
...
logo = Image.open("Palazzo_Adriano-Stemma.png")  # Sostituisci con il nome corretto
...
with col2:
    ...
    st.markdown(
        ...
        <div style="text-align: center; line-height: 1.1;">
            <h1 class="main-title">Assistente Virtuale</h1>
            <h3 class="subtitle">del Comune di Palazzo Adriano</h3>
        </div>
        """,
        unsafe_allow_html=True
    )
