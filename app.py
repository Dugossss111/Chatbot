...
with col2:
    st.image("P.A.I.gif", width=600)

# Titoli sopra la barra (ma sotto la barra rossa fissa)
st.markdown("""
<h1 style="position: relative; z-index: 10000; line-height: 1.2; color: #222222; text-align: center; font-weight: 700; text-shadow: 1px 1px 2px rgba(255,255,255,0.6);">
