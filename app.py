...
# Footer con disclaimer e credits
st.markdown("""
<style>
.note-box {
    font-size: 0.85rem;
...
<div class="note-box">
⚠️ Questo assistente utilizza l’intelligenza artificiale e potrebbe commettere errori. Verifica sempre le informazioni importanti.<br>
