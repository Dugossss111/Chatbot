...
logo_path = "Palazzo_Adriano-Stemma.png"
if os.path.exists(logo_path):
    with open(logo_path, "rb") as f:
        logo_b64 = base64.b64encode(f.read()).decode()
    st.markdown(f"""
    <div class="top-bar">
        <img src="data:image/png;base64,{logo_b64}" alt="Logo Comune">
    </div>
    """, unsafe_allow_html=True)
else:
    st.warning("File logo non trovato: Palazzo_Adriano-Stemma.png")
    
#st.image("Palazzo_Adriano-Stemma.png", width=200)
