...
h1 {
    font-size: 2.6rem;
    margin-bottom: 2px;  /* riduci il margine sotto h1 */
}

h2 {
    font-size: 2rem;
    margin-top: 0;        /* azzera margine sopra h2 */
    margin-bottom: 0;     /* azzera margine sotto h2 */
}

/* Input box personalizzata */
div.stTextInput > div > input {
    background-color: #fafafa; /* grigio molto chiaro */
    border: 1.5px solid #d71921; /* bordo rosso */
    border-radius: 8px;
    padding: 10px 15px;
